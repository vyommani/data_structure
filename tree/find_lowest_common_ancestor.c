...
int main(void){
    ...
    printf("\n Lowest common ancestor of 12, 17 is 16 = %d\n",LCA(tree,12,17) == 16); // This should return true.
    printf("\n Lowest common ancestor of 12, 12 is 18 = %d\n",LCA(tree,12,22) == 18); // this should return true.
    return 0;
}
